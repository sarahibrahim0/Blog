...
const UpdatePostModal = (props) => {
  ...
  const formSubmitHandler = (values) => {
    ...
    dispatch(updatePost({title: values['title'], description:values['description'], category: values['category']},props.post?._id));
...
initTE({ Modal });
  ...
  return (
    ...
    <div onClick={()=>props.setUpdatePost(false)}  className="w-full h-full absolute top-0 left-0 bg-transparent ">
    </div>
...
<button className="delete" type="button" href="" data-title='Delete Post' onClick={deletePostHandler}>
