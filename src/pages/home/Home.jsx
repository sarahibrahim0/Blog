    ...
    <section className=" w-full h-auto flex flex-col min-h-auto box-border ">
      <div className=" relative box-border w-full h-[564px] mb-11  ">
        <div className="  h-[560px] mt-1 pt-3  box-border flex flex-col justify-end items-center  text-center bg-white absolute top-0 right-0 w-full ">
          <img
            className=" adminPic object-cover inline-block rounded-full mb-6"
            src={admin?.profilePhoto?.url}
          />
          <span className=" text-black font-semibold lg:text-4xl md:text-2xl sm:text-lg mb-6">
            I'm Sarah Ibrahim
          </span>
          <ul className="scaleUp flex flex-row justify-center w-{250.625px} mb-6  ">
          ...
          <div className="w-full flex flex-row items-center justify-center z-10">
            <Link
              className="smIcon"
              to="https://www.linkedin.com/in/sarahibrahim0"
              target="_blank"
            ...
            <Link
              className="smIcon"
              to="https://github.com/sarahibrahim0"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <Link
              className="smIcon"
              to="mailto:sarahibrahimabdelhaimd@gmail.com"
              target="_blank"
            >
              <i className="fa-brands fa-google lg:text-xl md:text-base sm:text-base"></i>
            </Link>
            <Link className="smIcon" to="https://www.facebook.com/0SarahIbrahim/" target="_blank"
>
              <i className="fa-brands fa-facebook lg:text-xl md:text-base sm:text-base"></i>
            </Link>
            <Link className="smIcon" to={`https://wa.me/+201146446791?text=Hi,%20I'd%20like%20to%20chat%20with%20you%20on%20WhatsApp`}
 target="_blank"
>
